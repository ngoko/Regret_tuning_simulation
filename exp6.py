...
r = RegretTuning(datafile='./satunsat_runtime.csv', request_time_slot=600, conf_per_slot=140)
regret_period = 600*76
n = 300
k = 10
gplot_file_means = './satunsat_means_xp6.dat'
gplot_file_max = './satunsat_max_xp6.dat'
