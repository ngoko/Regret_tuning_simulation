...
r = RegretTuning(datafile='./satunsathard_runtime.csv', request_time_slot=600, conf_per_slot=100)
regret_period = 600*92
n = 300
k = 10
gplot_file_means = './satunsat_means_xp3.dat'
gplot_file_max = './satunsat_max_xp3.dat'
